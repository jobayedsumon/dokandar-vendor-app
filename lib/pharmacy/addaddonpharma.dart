...
class AddItemAddOnPharma extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AddAddOnPharma(productID, vendor_id),
    );
  }
}

class AddAddOnPharma extends StatefulWidget {
  final dynamic productID;
  final dynamic vendor_id;

  AddAddOnPharma(this.productID, this.vendor_id);

  @override
  State<StatefulWidget> createState() {
    return AddPharmaAddState();
  }
}

class AddPharmaAddState extends State<AddAddOnPharma> {
  dynamic currency;
  ...
  void newHitService(ProgressDialog pr, BuildContext context) async {
    if (productPriceC.text.isNotEmpty && productNameC.text.isNotEmpty) {
      pr.show();
      var storeEditUrl = pharmacy_addaddons;
