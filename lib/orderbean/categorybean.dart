...
class CategoryList{
  ...
  factory CategoryList.fromJson(dynamic json){
    return CategoryList(json['category_id'], json['cityadmin_id'], json['category_name'], json['category_image'], json['home'], json['created_at'], json['updated_at'], json['vendor_id']);
  }
